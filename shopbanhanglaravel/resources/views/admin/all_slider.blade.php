      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{$slider->slider_tieude}}</td>
            <td>{{$slider->slider_noidung}}</td>
            <td>{{$slider->slider_chenlinkSP}}</td>
            <td><img src="public/uploads/slider/{{ $slider->slider_hinhanhSP }}" height="100" width="100"></td>
            <td>
