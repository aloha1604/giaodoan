...
class ProductController extends Controller
{
    ...
    public function details_product($product_id){
        ...
        // ->where('tbl_product.product_id',$product_id)->where('tbl_khuyenmai.khuyenmai_maSP',$product_id)->get();
        ...
        return view('pages.sanpham.show_details')->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('relate',$related_product)->with('all_slider',$all_slider)->with('gia_Km',$gia_Km);   
    }
}
